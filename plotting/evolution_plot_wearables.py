...
# Shared x-axis label just above bottom edge
fig.text(0.5, 0.02, 'Generations', ha='center', va='center', fontsize=label_fs)

# Tight layout with minimal bottom margin
plt.tight_layout(pad=1, w_pad=0.5, h_pad=0.5, rect=[0, 0.04, 1, 0.98])
#plt.show()

plt.savefig('enas_plots_wearables.pdf', format='pdf', bbox_inches='tight')
